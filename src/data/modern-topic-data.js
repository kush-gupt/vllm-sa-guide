export const modernTopicData = {
  ...
  multimodal: {
    ...
    source: '<a href="https://github.com/vllm-project/vllm/blob/main/docs/design/mm_processing.md" target="_blank" rel="noopener">vLLM design docs: Multi-Modal Data Processing</a>',
  },
  structured: {
    ...
    why: 'Structured output tightens downstream parsing, but it lengthens prompts and can add logits or decode-time checks.',
