export const battleCards = [
  ...
  },
  {
    ...
    howVllmDiffers:
      'TensorRT-LLM is an NVIDIA-focused runtime and serving stack whose official materials emphasize CUDA-specific optimizations and detailed KV-cache controls. vLLM is usually the broader portability choice when teams want one serving layer across multiple hardware families or the wider vllm-project ecosystem.<a href="#source-3">[3]</a> <a href="#source-10">[10]</a>',
    keyDifferences: [
  ...
  },
  {
    ...
    howVllmDiffers:
      'SGLang is another active open-source serving stack. Its official materials highlight RadixAttention, structured generation, and gateway or routing features; vLLM highlights broad hardware coverage, multiple parallelism modes, and a large serving ecosystem. The better fit depends on your models, hardware, and latency or throughput targets.<a href="#source-18">[18]</a> <a href="#source-10">[10]</a>',
    keyDifferences: [
  ...
  },
  {
    ...
    keyDifferences: [
      ...
      'Production-facing features include OpenAI-compatible serving, structured outputs, multimodal paths, and LoRA support <a href="#source-7">[7]</a> <a href="#source-15">[15]</a> <a href="#source-14">[14]</a> <a href="#source-32">[32]</a>',
